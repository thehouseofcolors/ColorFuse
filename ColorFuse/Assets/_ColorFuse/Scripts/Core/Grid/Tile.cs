...
public class Tile : MonoBehaviour
{
    ...
    private async Task OnMouseDown()
    {
        ...
        await EventBus.PublishAsync(new SelectionEvents.TileSelectedEvent(this));
    }
    ...
    public void SetSelectableStatus(bool isSelectable)
    {
        ...
        if (IsEmpty)
        {
            EventBus.PublishAsync(new SelectionEvents.TileEmptiedEvent(this));
        }
    }
    ...
    public IEnumerator PlayPopAnimation(float duration)
    {
        // Animasyon efektleri, scale fade vb.
        yield return new WaitForSeconds(duration);
    }

    public IEnumerator PlayPushAnimation(float duration)
    {
        // Animasyon efektleri
        yield return new WaitForSeconds(duration);
    }
